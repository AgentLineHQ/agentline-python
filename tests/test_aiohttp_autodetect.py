...
class TestMakeDefaultAsyncClientWithoutAiohttp(unittest.TestCase):
    ...
    def test_returns_httpx_async_client(self) -> None:
        ...
        with mock.patch.dict(sys.modules, {"httpx_aiohttp": None}):
            from agentline_ai.client import _make_default_async_client
    ...
    def test_explicit_httpx_client_bypasses_autodetect(self) -> None:
        ...
        with mock.patch("agentline_ai.client._make_default_async_client") as mock_make:
...
class TestDefaultClientsWithoutAiohttp(unittest.TestCase):
    ...
    def test_default_async_httpx_client_defaults(self) -> None:
        ...
        from agentline_ai._default_clients import SDK_DEFAULT_TIMEOUT, DefaultAsyncHttpxClient
    ...
    def test_default_async_httpx_client_overrides(self) -> None:
        ...
        from agentline_ai._default_clients import DefaultAsyncHttpxClient
    ...
    def test_default_aiohttp_client_raises_without_package(self) -> None:
        ...
        import agentline_ai._default_clients

        with mock.patch.dict(sys.modules, {"httpx_aiohttp": None}):
            importlib.reload(agentline_ai._default_clients)

            with self.assertRaises(RuntimeError) as ctx:
                agentline_ai._default_clients.DefaultAioHttpClient()
            self.assertIn("pip install agentline-ai[aiohttp]", str(ctx.exception))
...
class TestDefaultClientsWithAiohttp(unittest.TestCase):
    ...
    def test_default_aiohttp_client_defaults(self) -> None:
        ...
        from agentline_ai._default_clients import SDK_DEFAULT_TIMEOUT, DefaultAioHttpClient
