...
from agentline_ai.core.http_client import (
    AsyncHttpClient,
    HttpClient,
    _build_url,
    _should_retry,
...
from agentline_ai.core.request_options import RequestOptions
...
@patch("agentline_ai.core.http_client.time.sleep", return_value=None)
...
@pytest.mark.asyncio
@patch("agentline_ai.core.http_client.asyncio.sleep", new_callable=AsyncMock)
